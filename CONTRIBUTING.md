# Contributing to tidyqpcr

This outlines how to propose a change to tidyqpcr.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("{{github_spec}}", fork = TRUE)`.
...
Please note that the tidyqpcr package is released with a [Contributor
Code of Conduct from rOpensci](https://ropensci.org/code-of-conduct/).
